...
class Model(object):
  ...
  def build_inception_graph(self):
    ...
    def decode_and_resize(image_str_tensor):
      ...
      # MY CODE http://androidkt.com/tensorflow-image-augmentation-using-tf-image/
      image = tf.image.flip_left_right(image) #flips
      import math
      image = tf.contrib.image.rotate(image, math.radians(180)) # rotates
      image = tf.contrib.image.translate(image,translations=[10,10]) # translation
